...
class HistoryVehicle extends StatefulWidget {
  @override
  _HistoryVehicleState createState() => _HistoryVehicleState();
}

class _HistoryVehicleState extends State<HistoryVehicle> {
  String veh_no;
